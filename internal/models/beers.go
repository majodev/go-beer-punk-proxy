...
var BeerTableColumns = struct {
	...
	Abv:              "beers.abv",
	Ibu:              "beers.ibu",
	TargetFG:         "beers.target_fg",
	TargetOg:         "beers.target_og",
	Ebc:              "beers.ebc",
	SRM:              "beers.srm",
	PH:               "beers.ph",
	AttenuationLevel: "beers.attenuation_level",
	Volume:           "beers.volume",
	BoilVolume:       "beers.boil_volume",
	Method:           "beers.method",
	Ingredients:      "beers.ingredients",
	FoodPairing:      "beers.food_pairing",
	BrewersTips:      "beers.brewers_tips",
	ContributedBy:    "beers.contributed_by",
	CreatedAt:        "beers.created_at",
	UpdatedAt:        "beers.updated_at",
}
...
var (
	...
	beerColumnsWithoutDefault = []string{"name", "tagline", "first_brewed", "description", "abv", "volume", "boil_volume", "method", "ingredients", "food_pairing", "brewers_tips", "contributed_by", "created_at", "updated_at"}
	beerColumnsWithDefault    = []string{"id", "image_url", "ibu", "target_fg", "target_og", "ebc", "srm", "ph", "attenuation_level"}
	beerPrimaryKeyColumns     = []string{"id"}
	beerGeneratedColumns      = []string{}
)

type (
	// BeerSlice is an alias for a slice of pointers to Beer.
	// This should almost always be used instead of []Beer.
	BeerSlice []*Beer
...
func Beers(mods ...qm.QueryMod) beerQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"beers\".*"})
	}
