...
var (
	...
	userColumnsWithoutDefault = []string{"username", "password", "is_active", "scopes", "last_authenticated_at", "created_at", "updated_at"}
...
func (o *User) AppUserProfile(mods ...qm.QueryMod) appUserProfileQuery {
	...
	query := AppUserProfiles(queryMods...)
	queries.SetFrom(query.Query, "\"app_user_profiles\"")
...
func (o *User) AccessTokens(mods ...qm.QueryMod) accessTokenQuery {
	...
	query := AccessTokens(queryMods...)
	queries.SetFrom(query.Query, "\"access_tokens\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"access_tokens\".*"})
	}
...
func (o *User) PasswordResetTokens(mods ...qm.QueryMod) passwordResetTokenQuery {
	...
	query := PasswordResetTokens(queryMods...)
	queries.SetFrom(query.Query, "\"password_reset_tokens\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"password_reset_tokens\".*"})
	}
...
func (o *User) PushTokens(mods ...qm.QueryMod) pushTokenQuery {
	...
	query := PushTokens(queryMods...)
	queries.SetFrom(query.Query, "\"push_tokens\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"push_tokens\".*"})
	}
...
func (o *User) RefreshTokens(mods ...qm.QueryMod) refreshTokenQuery {
	...
	query := RefreshTokens(queryMods...)
	queries.SetFrom(query.Query, "\"refresh_tokens\"")
